...
public class Main {
    ...
    private static void showLauncher() {
        ...
        gbc.gridy++;
        JLabel subtitle = new JLabel("[ COMPUTER — GAME LAUNCHER  v10 ]", SwingConstants.CENTER);
        ...
        gbc.gridy++;
        JButton golBtn = makeBigButton("▶  Conway's Game of Life  (v10)");
        ...
        gbc.gridy++;
        JLabel hint = new JLabel("Launch Conway's Game of Life", SwingConstants.CENTER);
