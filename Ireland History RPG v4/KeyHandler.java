...
public class KeyHandler implements KeyListener, MouseMotionListener, MouseListener {
    ...
    // Chapter-select number keys (title screen only) — consumed by GamePanel
    public boolean key1Pressed, key2Pressed, key3Pressed;

    // One-shot mouse click — consumed by GamePanel (used to advance story pages)
    public boolean mouseClickPressed;
    ...
    @Override public void mouseClicked(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1) mouseClickPressed = true;
    }
