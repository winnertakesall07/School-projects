...
public class Main {
    ...
    private static void showLauncher() {
        ...
        gbc.gridy++;
        JLabel subtitle = new JLabel("[ COMPUTER — GAME LAUNCHER  v5 ]", SwingConstants.CENTER);
        ...
        gbc.gridy++;
        JButton golBtn = makeBigButton("▶  Conway's Game of Life  (v5 — parallel sim, ultra speed)");
