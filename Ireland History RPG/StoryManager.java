 ...
 *
 * Vocabulary covered:
 *   to be the starting point | to be marked by smth | to conquer | innumerable
 *   to forcibly merge | to rebel against | flagrant (discrimination) | Home Rule
 *   devastating | civil war-like | faction | unionists vs nationalists
 */
public class StoryManager {
    ...
    private void buildChapter0() {
        ...
        pages.add(new StoryPage(
            ...
            "unity, however, each uprising was crushed in turn. Ireland's ordeal had only just begun.",
    ...
    private void buildChapter1() {
        ...
        pages.add(new StoryPage(
            ...
            "Rule \u2014 granting Ireland a degree of self-governance \u2014 split the island. " +
            "Unionists, loyal to Britain, fiercely opposed any change. Nationalists demanded " +
            "Home Rule as their birthright. The clash between unionists and nationalists " +
            "would define the coming age.",
