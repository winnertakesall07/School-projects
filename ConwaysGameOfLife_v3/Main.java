...
public class Main {
    ...
    private static void showLauncher() {
        JFrame frame = new JFrame("GoL Computer — Launcher v3");
        ...
        gbc.gridy++;
        JLabel subtitle = new JLabel("[ GAME OF LIFE — LAUNCHER  v3 ]", SwingConstants.CENTER);
        ...
        gbc.gridy++;
        JButton golBtn = makeBigButton("▶  Conway's Game of Life  (v3 — zoom / infinite board + TicTacToe)");
